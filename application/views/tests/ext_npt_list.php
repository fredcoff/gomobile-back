			...
			<td bgcolor="#ffffff" style="padding-bottom: 10px;">
				<table align="center" cellpadding="5" cellspacing="1" width="1600">
					<tbody>
						<tr height=50>
							<td>
								<b>Ext NPT (Count : <?php echo $this->pagination->total_rows;?>) </b>
							</td>
						</tr>
						<tr>
									...
									<tbody>
										...
										<tr>
											...
											<td align="left">
												...
												<p>Number of Test : <b><?php echo $json['nTestCount']; ?></b></p>
												<p>Test Interval : <b><?php echo $json['nTestInterval']; ?> seconds</b></p>
											</td>
											<td align="left">
												<p>Start At :</p>
