			...
			<td bgcolor="#ffffff" style="padding-bottom: 10px;">
				<table align="center" cellpadding="5" cellspacing="1" width="1400">
					<tbody>
						<tr height=50>
							<td>
								<b>Signal Strength (Count : <?php echo $this->pagination->total_rows;?>) </b>
							</td>
						</tr>
						<tr>
								...
								<table align="left" width="100%" class="list_table">
									<tbody>
										...
										<tr>
											...
											<td align="left">
												<?php if ($json['bIsMobile']) { ?>
													<p><b><?php echo $json['bIsLte'] ? "LTE" : "GSM"; ?></b></p>
													<p>GSM SS (0-31) : <b><?php echo $json['nGsmSS']; ?></b></p>
													<p>GSM SS (dBm) : <b><?php echo $json['nGsmDbm']; ?></b></p>
													<p>LTE SS (0-64) : <b><?php echo $json['nLteSS']; ?></b></p>
													<p>LTE SS (dBm) : <b><?php echo $json['nLteDbm']; ?></b></p>
												<?php } else { ?>
													<p>Strength (0-31) : <b><?php echo $json['nWifiSS']; ?></b></p>
													<p>IP : <b><?php echo $json['strIP']; ?></b></p>
													<p>MAC : <b><?php echo $json['strMAC']; ?></b></p>
													<p>SSID : <b><?php echo $json['strSSID']; ?></b></p>
													<p>Link Speed : <b><?php echo $json['strLinkSpeed']; ?></b></p>
												<?php } ?>
											</td>
											<td align="left">
												<p>Tested At : <b><?php echo $test['reg_date']; ?></b></p>
												<p>Uploaded At : <b><?php echo $json['strDateTime']; ?></b></p>
											</td>
										</tr>
										<?php endforeach; ?>
										<tr class="tr_padding">
